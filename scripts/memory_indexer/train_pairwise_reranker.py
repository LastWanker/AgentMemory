...
DEFAULT_SAVE_PATH = REPO_ROOT / "data" / "ModelWeights" / "pairwise_bipartite_reranker.pt"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Train pairwise reranker (default: bipartite).")
